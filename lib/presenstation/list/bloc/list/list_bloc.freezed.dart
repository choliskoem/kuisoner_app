...
mixin _$ListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Datum> data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Datum> data)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<Datum> data) : _data = data;
  ...
  @override
  String toString() {
    return 'ListState.success(data: $data)';
  }
...
abstract class _Success implements ListState {
  const factory _Success(final List<Datum> data) = _$SuccessImpl;
